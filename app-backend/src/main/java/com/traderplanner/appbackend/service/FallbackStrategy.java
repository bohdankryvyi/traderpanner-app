...
/**
 * Deterministic fallback when OpenAI is unavailable or rate-limited.
 * Picks ticker by day-of-year + timeframe hash; rotates through allowed patterns.
 */
@Component
public class FallbackStrategy {
    ...
    public PatternResponse buildFallback(String timeframe, List<SecurityDto> whitelist, String source) {
        ...
        List<String> tickers = whitelist.stream()
                .map(SecurityDto::getTicker)
                .sorted()
